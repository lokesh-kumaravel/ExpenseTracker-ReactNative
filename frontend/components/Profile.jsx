  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.profilePictureContainer}>
        {user.profilePciture ? (
          <Image
            source={{ uri: user.profilePciture }}
            style={styles.profilePicture}
          />
        ) : (
          <Text style={styles.noProfilePic}>No Profile Picture</Text>
        )}
      </View>
      ...
      <View style={styles.fieldContainer}>
        ...
        {isEditing ? (
          ...
          <Text style={styles.fieldValue}>{user.salary}</Text>
        )}
      </View>
